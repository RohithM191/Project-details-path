...
const TextAbove = () => (
  <div className="bold">
    ...
    <p>2.5.3 Supplementary flight plan (SPL) message<br/>
 2.5.3.1 Composition</p>
  </div>
);

export default function LineButton() {
  const lines = [
  <h3><p> 2.5.3.2 Submitted Supplementary flight plan (SPL) message </p><br/>
    (SPL-SAW502A<br/>
    –EDDW0920<br/>
   –EKCH0400 EKVB<br/>
   –REG/GBZTA RMK/CHARTER<br/>
  ...
  return (
    <div className="App">
      ...
      <div className="row">
        ...
        <MyCanvas number="13" content="Departure aerodrome and time" /><p>-</p>
      </div>
      ...
      <div className="row">
        <MyCanvas
          number="19"
          content="Supplementary information (using more than one line if necessary) "
        /><p>)</p></div> 
