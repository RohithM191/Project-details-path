...
const TextAbove = () => (
  <div className="bold">
    ...
    <p>2.3.5 Departure (DEP) message<br/>
 2.3.5.1 Composition</p>
  </div>
);

export default function LineButton() {
  const lines = [
  <h3><p> 2.3.5.2 Submitted Departure Message</p><br/>
  ...
  return (
    <div className="App">
      ...
      <div className="row">
        <MyCanvas
          number="18"
          content="Other information ( using more then one line if necessary)"
        /><p>)</p></div>
